...
import (
	...
	"git.imooc.com/coding-535/user/proto/permission"
	"git.imooc.com/coding-535/user/proto/role"
	"path/filepath"

	service2 "git.imooc.com/coding-535/user/domain/service"
	"git.imooc.com/coding-535/user/handler"
	...
	user "git.imooc.com/coding-535/user/proto/user"
	"k8s.io/client-go/kubernetes"
	"k8s.io/client-go/tools/clientcmd"
	"k8s.io/client-go/util/homedir"
	//hystrix2 "git.imooc.com/coding-535/user/plugin/hystrix"
	"strconv"
)
